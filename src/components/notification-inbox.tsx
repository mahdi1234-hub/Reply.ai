...
import { useKnockReady } from "./client-providers";
...
// Export wrapper that only renders the feed when Knock provider is ready
export default function NotificationInbox() {
  const knockReady = useKnockReady();

  if (!knockReady) {
    // Show plain bell icon while Knock provider is loading
    return (
      <div className="relative">
